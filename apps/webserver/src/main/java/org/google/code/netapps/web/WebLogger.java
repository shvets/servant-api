...
/**
 * The logger class for web server
 *
 * @version 1.0 05/21/2001
 * @author Alexander Shvets
 */
public class WebLogger extends LogFile {
   ...
   */
  public WebLogger(String fileName) throws IOException {
    super(fileName);
  }
   ...
   * @exception IOException  if an I/O error occurs
   */
  public WebLogger(String fileName, boolean delete) throws IOException {
    super(fileName, delete);
  }

  /**
   * Adds new message to a logger
   *
