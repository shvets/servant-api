// InfoWormConnectionFactory.java
...
/**
 * This class the factory for HTTP connections.
 *
 * @version 1.0 08/09/2001
 * @author Alexander Shvets
*/
public class InfoWormConnectionFactory implements ConnectionFactory {
  ...
  /**
   * Creates new HTTP connection factory
   *
   * @param server  the server
   */
  public InfoWormConnectionFactory(Server server) {
    this.server = server;
  }
  ...
  public Connection create() throws IOException {
    return new InfoWormConnection(server, serverSocket.accept());
  }
